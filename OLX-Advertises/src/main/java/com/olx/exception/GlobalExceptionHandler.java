...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(value = {InvalidAdvertiseDeleteIdException.class} )
	public ResponseEntity<Object> handleInvalidAdvertiseDeleteIdException(RuntimeException exception,WebRequest request){
